import { o as objectType, g as dateType, n as numberType, h as arrayType, s as stringType, A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, r as renderTemplate, i as escape, j as renderUniqueStylesheet, k as renderScriptElement, l as createHeadAndContent, f as renderComponent } from './astro/server_CfBrhgpW.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_GF43_WQa.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DnqDC0td.mjs').then(n => n._);
